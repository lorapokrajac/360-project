...
<div class="header">	
	...
	<div class="breadcrumb">
		...
		<a href="genre.php">Genre</a> >
		<a href="documentary.php">Documentaries</a> >
		<a href="kissTheGround.php">Kiss The Ground</a>
	</div>
</div>
...
<div class="main">
	...
	<div class="col-right">
		<div class="card">
			...
			<h3>Directed By:</h3><p> Rebecca Harrell Tickell, Josh Tickell</p>
			<h3>Actors:</h3><p>Ian Somerhalder, Woody Harrelson, Gisele Bündchen, Patricia Arquette </p>
		</div>
		<div class="card">
			<h3>Description</h3><p>Discussions revolving around regenerative agriculture to save the planet's topsoil. </p>
		</div>
		<div class="card">
		<h3>Release date:</h3><p>September 22, 2020</p>
		</div>
		<div class="card">
