...
<div class="header">	
	...
	<div class="breadcrumb">
		...
		<a href="godzillaKong.php">godzilla Vs. Kong</a>
	</div>
</div>
...
<div class="main">
	...
	<div class="col-right">
		<div class="card">
			...
			<h3>Directed By:</h3><p>Adam Wingard</p>
			<h3>Actors:</h3><p>Millie Bobby Brown, Alexander Skarsgård, Rebecca Hall, Julian Dennison</p>
		</div>
		<div class="card">
			<h3>Description</h3><p>Kong and his protectors undertake a journey to find his true home where they soon encounter Godzilla who is full of destruction. </p>
		</div>
		<div class="card">
		<h3>Release date:</h3><p>March 31, 2021</p>
		</div>
		<div class="card">
